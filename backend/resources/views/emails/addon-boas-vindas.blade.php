...
<body style="margin:0;padding:24px;background:#f5f7fb;font-family:Arial,sans-serif;color:#111827;">
    <div style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;padding:32px;">
        ...
        @if ($contaNova)
            <p style="margin:0 0 16px;font-size:16px;line-height:1.7;">Olá, {{ $nome }}. Sua conta foi criada e o <strong>{{ $addonLabel }}</strong> já está disponível. Use as credenciais abaixo para acessar a plataforma.</p>
            <p style="margin:0 0 4px;font-size:16px;line-height:1.7;"><strong>E-mail:</strong> {{ $email }}</p>
            <p style="margin:0 0 16px;font-size:16px;line-height:1.7;"><strong>Senha temporária:</strong> 12345678</p>
