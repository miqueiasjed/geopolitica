    ...
    <div className="flex min-h-[60vh] items-center justify-center px-6 py-16">
      <div className="flex max-w-md flex-col items-center gap-6 text-center">
        ...
        <div className="w-full rounded-xl border border-[#C9B882]/30 bg-zinc-900/60 px-6 py-5">
          ...
          <p className="mt-1 text-2xl font-bold text-[#C9B882]">Disponível no plano Pro</p>
        </div>
        <a
...
function RiskScoreContent({ prefersReduced }: { prefersReduced: boolean }) {
  ...
  return (
    ...
    >
      {/* ── Cabeçalho ───────────────────────────────────────────────────── */}
      <div>
        <p className="font-mono text-[10px] uppercase tracking-widest text-[#C9B882]/60">
      ...
      <section className="rounded-xl border border-[#C9B882]/20 p-6">
            ...
            {ativos.map((ativo, idx) => (
              ...
              >
                ...
                <input
                  ...
                  className="w-24 rounded-lg border border-white/10 bg-white/5 px-3 py-2 font-mono text-sm uppercase text-white placeholder-white/20 outline-none focus:border-[#C9B882]/40 focus:ring-0"
                />
                ...
                <div className="flex items-center gap-1">
                  <input
                    ...
                    className="w-20 rounded-lg border border-white/10 bg-white/5 px-3 py-2 font-mono text-sm text-white placeholder-white/20 outline-none focus:border-[#C9B882]/40 focus:ring-0"
                  />
        ...
        <div className="mt-3 flex items-center gap-3">
          <button
            ...
            className="font-mono text-xs text-[#C9B882]/60 transition-colors hover:text-[#C9B882] disabled:cursor-not-allowed disabled:opacity-30"
          >
            + Adicionar ativo
          </button>
        ...
        <button
          ...
          className="mt-6 inline-flex items-center gap-2 rounded-lg border border-[#C9B882]/30 bg-[#C9B882]/10 px-5 py-2.5 font-mono text-xs uppercase tracking-widest text-[#C9B882] transition-all hover:bg-[#C9B882]/20 disabled:cursor-not-allowed disabled:opacity-30"
        >
          {calculando ? (
            <>
              <span
                className="h-3 w-3 animate-spin rounded-full border border-[#C9B882]/40 border-t-[#C9B882]"
                aria-hidden="true"
              />
              Calculando…
            </>
      ...
      <AnimatePresence>
        {score !== null && (
          ...
          >
            {/* Score total */}
            <div className="border border-[#C9B882]/20 rounded-xl p-6 mt-6">
              <p className="text-xs tracking-widest uppercase text-[#C9B882]/60">
