...
```
.claude/skills/design-squad/agents/design-chief.md   → Orquestrador (ponto de entrada)
.claude/skills/design-squad/agents/brad-frost.md     → Atomic design
.claude/skills/design-squad/agents/dan-mall.md       → Design systems
.claude/skills/design-squad/agents/dave-malouf.md    → DesignOps
.claude/skills/design-squad/agents/ux-designer.md    → UX
.claude/skills/design-squad/agents/design-system-architect.md
.claude/skills/design-squad/agents/visual-generator.md
.claude/skills/design-squad/agents/ui-engineer.md
```
